...
ggsave( "boxplot lineage .svg", dpi = 900) 
...
ggplot(data = lineage, aes(x = Date, y = Nextstrain_clade,  fill=Nextstrain_clade))+
  ...
  labs(x='Time',y='SARS-CoV-2 Clades')
ggsave( "boxplot lineage byreg.svg", dpi = 900) 
...
ggsave( "Density pang app .svg", dpi = 900) 
...
labs(y = 'Density (Lineage appearence date)')
ggsave( "Density pang app date.svg", dpi = 900) 
...
ggsave( "hist mut date.svg", dpi = 900) 
...
ggplot(muts_appT, aes(x=anytime::anydate(Date), y=Freq))+
  ...
  ggplot2::coord_cartesian(ylim = c(0,NA) )+
  labs(y = 'Density (Lineage appearence date)')
ggsave( "Density Lineage app date.svg", dpi = 900) 
...
ggsave( "Density Lineage app date 2.svg", dpi = 900) 
...
ggplot(data = covid, aes(x=Date, y=covid$new_cases_per_million))+
  ...
  geom_smooth()
ggsave( "new_cases_per_million .svg", dpi = 900) 
...
ggplot(lineages , aes( x=day, color=continent ))+
  ...
  geom_density()
ggsave( "lineages lifespane .svg", dpi = 900) 
...
ggsave( "lineages lifespane selected .svg", dpi = 900) 
...
ggsave( "lineages lineages_lifeM .svg", dpi = 900) 
...
ggsave( "lineages lineages_lifeM 2 .svg", dpi = 900) 
...
ggsave( "lineages MutEscp 2 .svg", dpi = 900) 
...
ggsave( "lineages div 2 .svg", dpi = 900) 
...
ggsave( "Divergence1 2 .svg", dpi = 900) 
...
ggsave( "Mutation ESCAP SCR CLADE .svg", dpi = 900) 
...
ggsave( "Mutation ESCAP SCR BLE .svg", dpi = 900) 
