...
ggplot(data=cov, aes(x=date,y=new_cases_per_million,color=continent))+
...
ggplot(lineages_hiv, aes(x = hiv, y = freq))+
  geom_point()+
  coord_cartesian(ylim=c(0, NA), expand = FALSE)+
  geom_smooth(method = 'glm', se= FALSE, fullrange= TRUE)
...
aa_time$YM <- zoo::yearmon((aa_time$date))
